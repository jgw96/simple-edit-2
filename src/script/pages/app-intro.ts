      ...
      <div id="getting-started-grid">
        <div class="getting-started-item">
          ...
          >
            ...
            />
            <polygon
              points="698.98 653.075 663.827 647.561 678.302 632.397 698.98 632.397 698.98 653.075"
              fill="#a0616a"
            />
            <path
              ...
              transform="translate(-169.85872 -119.10383)"
              fill="#2f2e41"
            />
            <path
            ...
            />
            <polygon
              points="665.09 406.555 649.991 393.612 651.429 380.67 665.09 380.67 665.09 406.555"
              fill="#a0616a"
            />
            <path
            ...
            />
            <path
              id="feda1070-6288-4949-b833-330f4749d65f"
              data-name="Path 40"
            ...
            <rect
              ...
              width="353.44729"
              height="2.23518"
              transform="translate(-321.57903 245.71371) rotate(-39.33239)"
              fill="#e6e6e6"
            />
            <rect
              x="433.419"
              ...
              width="2.235"
              height="354.15673"
              transform="translate(-316.67736 360.12744) rotate(-50.50975)"
              fill="#e6e6e6"
            />
            <path
            ...
            <rect
              ...
              width="24.58832"
              height="24.58832"
              transform="translate(839.33157 572.37909) rotate(-180)"
              fill="#3f3d56"
            />
          </svg>
          <p>
            Quickly edit your photos, create collages and more with filters,
            text controls, and more! SimpleEdit works on any device, your phone,
            tablet and laptop.
          </p>

          <!-- <sl-button @click="${() =>
            this.scrollRight()}">Next</sl-button>-->
        </div>
